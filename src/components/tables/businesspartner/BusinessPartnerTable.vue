              ...
              <v-row justify="space-around" dense="">
                ...
                <v-col cols="4">
                  <v-row dense class="pa-10">
                    ...
                    <!-- :to="{ name: 'GenerateLinkPage', query: {
                    taxpayer_id_number: 'taxpayer_id_number', name_th:
                    'name_th', }, }" -->
                    <!-- <v-col cols="12">
                      <v-btn block to="/BusinessPartner/ExtendCompany" class="text-capitalize rounded-pill"
                    ...
                    <v-col cols="12">
                      <v-btn
                        block
                        to="/BusinessPartner/AttachedDocument"
                        class="text-capitalize rounded-pill"
