        ...
        >
          <v-row>
            ...
            <v-col cols="2" align-self="center">
              ...
              <v-chip
                color="#148DB4"
                v-if="item.account_task_action === 'Change Info.'"
                variant="elevated"
                label
              >
                Change Info.
            ...
            <v-col cols="1" align-self="center">
              <h4>
                {{ item.contact_owner?.role?.name }}
              </h4>
            </v-col>
            <v-col cols="3" align-self="center">
              <h4>
                {{ item.account_task_action }}
              </h4>
            </v-col>
            <v-col cols="3" align-self="center">
              ...
              <v-menu transition="scale-transition">
                ...
                <v-list dense>
                  <v-list-item
                    ...
                    :key="menu.id"
                    @click.stop
                    @click="handleMuneClick(menu.id, item.id)"
...
const handleMuneClick = (event_id, item_id) => {
  emit("handle-menu-clicked", { event_id, item_id });
};
